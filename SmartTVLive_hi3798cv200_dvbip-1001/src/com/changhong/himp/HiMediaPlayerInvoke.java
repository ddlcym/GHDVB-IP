...
public class HiMediaPlayerInvoke
{
    ...
    /**
       ...
       <br>
       <h3>Attention:</h3>
       Invalid when video data through SurfaceFlinger(OpenGL and HWComposer).
    */
    ...
    */
    ...
    /**
       ...
       <br>
       <h3>Attention:</h3>
       Not support Video-based synchronization.
    */
    ...
    /**
        ...
        <h3>Reply:</h3>
            ...
            <tr>
                <td>3</p></td>
                <td>int</p></td>
                <td>bit rate(bps)</p></td>
            </tr>
            <tr>
                <td>4</p></td>
                <td>long</p></td>
                <td>file size(byte)</p></td>
            </tr>
            <tr>
                <td>5</p></td>
                <td>int</p></td>
    ...
    /**
        ...
        <h3>Reply:</h3>
            ...
            <tr>
                <td>4</p></td>
                <td>int</p></td>
                <td>Sample rate of every track(hz)</p></td>
            </tr>
            <tr>
                <td>5</p></td>
                <td>int</p></td>
    ...
    */
    ...
    /**
        <br>
        Set subtitle font vertical position.<br>
        <h3>Description:</h3>
        None
        <h3>Request:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value of CMD_SET_SUB_FONT_VERTICAL</p></td>
            </tr>
            <tr>
                <td>1</p></td>
                <td>int</p></td>
    ...
    */
    ...
    /**
        <br>
        Set sub font space between lines.<br>
        <h3>Description:</h3>
        None
        <h3>Request:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value of CMD_SET_SUB_FONT_LINESPACE</p></td>
            </tr>
            <tr>
                <td>1</p></td>
                <td>int</p></td>
    ...
    */
    ...
    /**
        ...
        <br>
        <h3>Attention:</h3>
        only for extern text subtitle,subtitle type is {@see HiMediaPlayerDefine.DEFINE_SUBT_FORMAT}
    */
    ...
    /**
        ...
        <h3>Request:</h3>
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value of CMD_SET_SUB_FONT_STYLE</p></td>
            </tr>
            <tr>
                <td>1</p></td>
                <td>int</p></td>
    ...
    /**
        ...
        <h3>Request:</h3>
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value of CMD_SET_SUB_DISABLE</p></td>
            </tr>
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>0 enable,>0 disable</p></td>
            </tr>
            </table>
        <h3>Reply:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
    ...
    /**
        ...
        <h3>Request:</h3>
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value 0 display all subtile in himediaplayer, value 1 display text in apk and bmp in himediaplayer</p></td>
                <td>But If you use mode 0,you need set subtitle surface by {@link #CMD_SET_SUB_SURFACE}</td>
            </tr>
            </table>
        <h3>Reply:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
        ...
        <br>
    */
    public final static int CMD_SET_SUB_MODE = CMD_INVOKE_BASE + 144;          // set subtitle mode
    //145-198 is reserved
    ...
    /**
        ...
        <h3>Request:</h3>
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value of CMD_GET_HLS_BANDWIDTH</p></td>
            </tr>
            </table>
        <h3>Reply:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
    ...
    */
    ...
    /**
        ...
        <b>timeout:</b>if do not receive data exceed timeout(ms) setting.timeout msg will reported.<br>
        <b>eg full(5*1024) start(512) enough(4*1024) timeout(1000)
        <br>
        <h3>Request:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
            <tr>
    ...
    */
    ...
    /**
        ...
        <b>full:</b>now full is no use,but in some reason,you must set a value,the value must obey the principle:full > enough > start<br>
        <b>timeout:</b>if do not receive data exceed timeout(ms) setting.timeout msg will reported.<br>
        <b>eg full(5000) start(1000) enough(3000) timeout(2*60*1000)
        <br>
        <h3>Request:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
            <tr>
    ...
    */
    ...
    /**
        ...
        <h3>Description:</h3>
        this is only used for time buffer setting.<br>
        e.g. if you set max buffer size 100MB， set buffer full time 100s.
        ...
        <h3>Request:</h3>
            ...
            <tr>
                <td>1</p></td>
                <td>int</p></td>
                <td>Max buffer size,must >= 2*1024(KByte)</p></td>
            </tr>
            </table>
        <h3>Reply:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
    ...
    */
    ...
    /**
        ...
        <h3>Description:</h3>
        refer to the method CMD_SET_BUFFERTIME_CONFIG.if current buffer is less than 'start'<br>
        setting,player will pause automatic,in order to accumulate more buffer to play.when buffer<br>
        rise up to 'enough' or more,Player resume play automatic.User can also disable the<br>
        ...
        <br>
        <h3>Attention:</h3>
        you can refer to CMD_SET_BUFFERTIME_CONFIG to know more about buffer cache control.
    */
    ...
    */
    ...
    /**
        ...
        Set dac enable.<br>
        <h3>Description:</h3>
        enable/disable dac force output<br>
        <h3>Request:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
            <tr>
                <th>Parcel Index</th>
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value of CMD_SET_DAC_DECT_ENABLE</p></td>
            </tr>
            <tr>
                <td>1</p></td>
                <td>int</p></td>
                <td>1--enable 0--disable</p></td>
            </tr>
            </table>
        <h3>Reply:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
    ...
    /**
       ...
       <h3>Request:</h3>
            ...
            <tr>
                <td>1</p></td>
                <td>int</p></td>
                <td>The value of drcmode.(0--3)</p></td>
            </tr>
            </table>
       <h3>Reply:</h3>
       <table border="1" cellspacing="0" cellpadding="0">
    ...
    */
    ...
    /**
       ...
       <br>
       <h3>Attention:</h3>
       It is invalid for net stream play in overlay/hwc mode.
    */
    ...
    /**
       ...
       <h3>Request:</h3>
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value of CMD_SET_CMCC_AUDIO_CHANNEL</p></td>
            </tr>
            <tr>
                <td>1</p></td>
                <td>int</p></td>
                <td>0--DOUBLE_LEFT, 1--DOUBLE_RIGHT, 2--STEREO</p></td>
            </tr>
            </table>
       <h3>Reply:</h3>
       <table border="1" cellspacing="0" cellpadding="0">
       ...
       None.
    */
    public final static int CMD_SET_CMCC_AUDIO_CHANNEL = CMD_INVOKE_BASE + 331;
    ...
    /**
       ...
       This is valid for android mediaplayer interface.
    */
    public final static int CMD_SET_LOW_DELAY = CMD_INVOKE_BASE + 332;
    ...
    */
    ...
    /**
        <br>
        set the highest resolution for scanning media restrictions.<br>
        <h3>Description:</h3>
        you can set the highest resolution for scanning media restrictions.<br>
        <h3>Request:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
            <tr>
                <th>Parcel Index</th>
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value of CMD_SET_THUMBNAIL_RESTRICT</p></td>
            </tr>
            <tr>
                <td>1</p></td>
                <td>int</p></td>
                <td>The width of the highest resolution rations</p></td>
            </tr>
            <tr>
                <td>2</p></td>
                <td>int</p></td>
                <td>The height of the highest resolution rations</p></td>
            </tr>
            </table>
        <h3>Reply:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
        ...
        <br>
        <h3>Attention:</h3>
        when resolution rations is 0*0 means there are no limit, and it can't less than 0*0.
    */
    public final static int CMD_SET_THUMBNAIL_RESTRICT = CMD_INVOKE_BASE + 335; //set the highest resolution for scanning media restrictions

    /**
        <br>
        Set mode for HDR.<br>
        <h3>Description:</h3>
        you can set different mode to play HDR stream.:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
            <tr>
                <th>Parcel Index</th>
                <th>Type</th>
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value of CMD_SET_HDR_MODE</p></td>
            </tr>
            <tr>
                <td>1</p></td>
                <td>int</p></td>
                <td>0 : SDR display mode  1: HDR display mode. </p></td>
            </tr>
            </table>
        <h3>Reply:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
        ...
        None
    */
    public final static int CMD_SET_HDR_MODE = CMD_INVOKE_BASE + 336; // 0 : sdr display mode  1: hdr display mode.
    ...
    /**
        ...
        <h3>Request:</h3>
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value of CMD_GET_DTSM6INFO</p></td>
            </tr>
            </table>
        <h3>Reply:</h3>
            <table border="1" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>2</p></td>
                <td>int</p></td>
                <td>{@see HiMediaPlayerDefine.DEFINE_DTSM6_STREAMTYPE_INFO}</p></td>
            </tr>
            <tr>
                <td>3</p></td>
                <td>int</p></td>
        ...
        <br>It is valid to HiMediaplayer interface.
       */
    public final static int CMD_GET_DTSM6INFO = CMD_INVOKE_BASE + 337;

    /**
            <b>Unsurport ID.</b>
        */
    public final static int CMD_TYPE_BUTT = CMD_INVOKE_BASE + 10000;        //unsurport ID
}
